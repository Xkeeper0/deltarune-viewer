...
if (self.facing == 1)
    draw_sprite_ext(self.sprite_index, self.walk_index, (self.x + self.sprite_width), self.y, (variable)(- self.image_xscale), self.image_yscale, self.image_angle, self.image_blend, self.image_alpha)
if scr_debug()
{
