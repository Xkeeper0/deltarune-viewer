if (self.state == 3)
{
    if (global.monsterhp[self.myself] <= (global.monstermaxhp[self.myself] / 3))
    {
        ...
        if (global.monstercomment[self.myself] == " "@24)
            global.monstercomment[self.myself] = scr_84_get_lang_string("obj_ponman_enemy_slash_Draw_0_gml_6_0"@8366)
    }
    ...
    else
    {
        ...
        if (self.sleeping == 0)
            draw_sprite_ext(spr_ponman_eye, 0, ((self.x + 28) + self.eyex), ((self.y + 32) + self.eyey), 2, 2, 0, 0xFFFFFF, 1)
        if (self.sleeping == 1)
        {
...
if (self.state == 0)
{
    ...
    if (self.sleeping == 1)
    {
        ...
        if (self.sleep_index > 0.5)
            self.sleep_index = (self.sleep_index - 0.25)
    }
    ...
    if (self.flash == 1)
    {
        ...
        draw_sprite_ext(self.thissprite, self.this_index, self.x, self.y, 2, 2, 0, self.image_blend, (((variable)(- cos((self.fsiner / 5))) * 0.4) + 0.6))
        d3d_set_fog(0, 0, 0, 0)
    }
}
