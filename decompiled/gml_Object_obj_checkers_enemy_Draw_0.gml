if (self.state == 3)
{
    ...
    else
    {
        ...
        self.siner = 0
        draw_sprite_ext(spr_checkers_idle, 0, (self.x + self.shakex), self.y, 2, 2, 0, self.image_blend, 1)
    }
}
if (self.state == 0)
{
    self.siner = (self.siner + 1)
    self.thissprite = spr_checkers_idle
    ...
    if (self.flash == 1)
    {
        ...
        draw_sprite_ext(self.thissprite, (self.siner / 3), self.x, self.y, 2, 2, 0, self.image_blend, (((variable)(- cos((self.fsiner / 5))) * 0.4) + 0.6))
        d3d_set_fog(0, 0, 0, 0)
    }
}
