...
global.filechoice = 0
global.plot = 0
global.truename = ""@2240
global.othername[0] = ""@2240
global.othername[1] = ""@2240
global.othername[2] = ""@2240
global.othername[3] = ""@2240
global.othername[4] = ""@2240
global.othername[5] = ""@2240
global.othername[6] = ""@2240
global.time = 0
global.fighting = 0
global.char[0] = 1
global.char[1] = 0
...
while(true)
{
    if (self.i < 4)
    {
        ...
        global.weaponstyle[self.i] = scr_84_get_lang_string("scr_gamestart_slash_scr_gamestart_gml_69_0"@2611)
        self.q = 0
        while(true)
        {
            if (self.q < 4)
...
global.charname[0] = " "@24
global.charname[1] = scr_84_get_lang_string("scr_gamestart_slash_scr_gamestart_gml_98_0"@2617)
global.charname[2] = scr_84_get_lang_string("scr_gamestart_slash_scr_gamestart_gml_99_0"@2618)
global.charname[3] = scr_84_get_lang_string("scr_gamestart_slash_scr_gamestart_gml_100_0"@2619)
...
while(true)
{
    if (self.i < 3)
    {
        ...
        global.monstername[self.i] = scr_84_get_lang_string("scr_gamestart_slash_scr_gamestart_gml_206_0"@2623)
...
while(true)
{
    if (self.i < 10)
    {
        ...
        global.writerimg[self.i] = scr_84_get_sprite("spr_btact"@1828)
...
global.smstring[1] = " "@24
self.i = 0
while(true)
{
    if (self.i < 100)
    {
        global.msg[self.i] = "%%"@1081
        self.i = (self.i + 1)
        continue
    }
    break
...
while(true)
{
    if (self.i < 9)
    {
        ...
        global.litemname[self.i] = ""@2240
        global.phone[self.i] = 0
        global.phonename[self.i] = ""@2240
        self.i = (self.i + 1)
        continue
    }
    break
...
while(true)
{
    if (self.i < 100)
    {
        global.msg[self.i] = " "@24
        self.i = (self.i + 1)
        continue
    }
    break
}
global.choicemsg[0] = scr_84_get_lang_string("scr_gamestart_slash_scr_gamestart_gml_325_0"@2639)
global.choicemsg[1] = scr_84_get_lang_string("scr_gamestart_slash_scr_gamestart_gml_326_0"@2640)
global.choicemsg[2] = scr_84_get_lang_string("scr_gamestart_slash_scr_gamestart_gml_327_0"@2641)
global.choicemsg[3] = scr_84_get_lang_string("scr_gamestart_slash_scr_gamestart_gml_328_0"@2642)
self.i = 0
while(true)
{
    if (self.i < 9999)
...
global.litem[0] = 0
global.litemname[0] = " "@24
global.phone[0] = 201
global.phonename[0] = scr_84_get_lang_string("scr_gamestart_slash_scr_gamestart_gml_343_0"@2643)
global.lcharname = scr_84_get_lang_string("scr_gamestart_slash_scr_gamestart_gml_345_0"@2644)
global.lweapon = 2
global.larmor = 3
global.lxp = 0
global.llv = 1
