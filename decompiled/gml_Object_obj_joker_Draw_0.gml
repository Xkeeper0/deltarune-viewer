if (self.state == 3)
{
    if (self.hurttimer > 0)
    {
        ...
        self.body.siner = 0
        self.body.maxdist = (self.body.maxdist + (20 + (self.hurtamt / 5)))
        ...
        if (self.mhpratio <= 0.8)
            _temp_local_var_1 = (self.body.dancelv == 0)
        else
            _temp_local_var_1 = 0
        if _temp_local_var_1
            self.body.dancelv = 1
        if (self.mhpratio <= 0.4)
            _temp_local_var_2 = (self.jturn < 17)
        else
            _temp_local_var_2 = 0
        if _temp_local_var_2
            self.body.dancelv = 3
        if (self.mhpratio <= 0.2)
            _temp_local_var_3 = (self.jturn == 17)
        else
            _temp_local_var_3 = 0
...
if (self.state == 0)
{
    ...
    if (self.flash == 1)
    {
        ...
        with(self.body)
        {
            ...
            if (self.dancelv == 0)
                draw_sprite_ext(spr_joker_main, 0, (self.offx + self.flyx), (self.offy + self.fly), 2, 2, 0, self.image_blend, (((variable)(- cos((self.fsiner / 5))) * 0.4) + 0.6))
            if (self.dancelv == 1)
                draw_sprite_ext(spr_joker_dance, (self.floatsiner / 3), (self.offx + self.flyx), (self.offy + self.fly), 2, 2, 0, self.image_blend, (((variable)(- cos((self.fsiner / 5))) * 0.4) + 0.6))
            if (self.dancelv == 2)
                draw_sprite_ext(spr_joker_tired, 0, (self.offx + self.flyx), (self.offy + self.fly), 2, 2, 0, self.image_blend, (((variable)(- cos((self.fsiner / 5))) * 0.4) + 0.6))
            d3d_set_fog(0, 0, 0, 0)
        }
    }
}
