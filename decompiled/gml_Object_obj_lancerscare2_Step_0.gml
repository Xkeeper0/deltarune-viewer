...
if (self.con == 1)
{
    snd_free_all()
    self.mm = 0.5
    self.image_blend = merge_color(0x00FFFFFF, 0x00000000, self.mm)
    global.interact = 1
