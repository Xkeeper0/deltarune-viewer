var __prop = self.argument0
var __index = self.argument1
var __val = self.argument2
switch __prop
{
    case 0:
    ...
    case 9:
        ...
        break
    case 10:
        self.__res = view_set_visible(__index, __val)
        break
    case 11:
        self.__res = view_set_xport(__index, __val)
        break
    case 12:
        self.__res = view_set_yport(__index, __val)
        break
    case 13:
        self.__res = view_set_wport(__index, __val)
        break
    case 14:
        self.__res = view_set_hport(__index, __val)
        break
    case 15:
        self.__res = view_set_camera(__index, __val)
        break
    case 16:
        self.__res = view_set_surface_id(__index, __val)
        break
    default:
        break
}
