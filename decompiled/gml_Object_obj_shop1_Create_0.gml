...
self.murder = 0
self.moff = 415
global.currentsong[0] = snd_init("shop1.ogg"@9263)
...
self.itemtype[1] = "item"@103
self.itemtype[2] = "armor"@167
self.itemtype[3] = "weapon"@166
self.itemtype[4] = "item"@103
self.itemtype[5] = "item"@103
self.itemtype[6] = "item"@103
self.shopdesc[0] = scr_84_get_lang_string("obj_shop1_slash_Create_0_gml_74_0"@9269)
self.shopdesc[1] = scr_84_get_lang_string("obj_shop1_slash_Create_0_gml_75_0"@9270)
self.shopdesc[2] = scr_84_get_lang_string("obj_shop1_slash_Create_0_gml_76_0"@9271)
self.shopdesc[3] = scr_84_get_lang_string("obj_shop1_slash_Create_0_gml_77_0"@9272)
self.i = 0
while(true)
{
