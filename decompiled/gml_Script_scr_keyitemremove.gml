...
if (self.haveit == 1)
{
    self.loc = 0
    self.skip = 0
    if (global.keyitem[0] == self.argument0)
    ...
    if (global.keyitem[1] == self.argument0)
    ...
    if (global.keyitem[2] == self.argument0)
    ...
    if (global.keyitem[3] == self.argument0)
    ...
    if (global.keyitem[4] == self.argument0)
    ...
    if (global.keyitem[5] == self.argument0)
    ...
    if (global.keyitem[6] == self.argument0)
    ...
    if (global.keyitem[7] == self.argument0)
    ...
    if (global.keyitem[8] == self.argument0)
    ...
    if (global.keyitem[9] == self.argument0)
    ...
    if (global.keyitem[10] == self.argument0)
    ...
    if (global.keyitem[11] == self.argument0)
