...
{
    self.siner = 0
    draw_sprite_ext(spr_puzzlemaster_body, self.type, self.x, self.y, 2, 2, 0, 0xFFFFFF, 1)
...
if (self.myinteract == 3)
{
    ...
    if (global.flag[20] == 0)
    {
        draw_sprite_ext(spr_puzzlemaster_body, self.type, self.x, (self.y - (sin((self.siner / 4)) * 3)), 2, (2 + (sin((self.siner / 4)) * 0.1)), 0, 0xFFFFFF, 1)
    ...
    if (global.flag[20] == 1)
    {
        ...
        draw_sprite_ext(spr_puzzlemaster_body, self.type, self.x, self.y, 2, 2, 0, 0xFFFFFF, 1)
        draw_sprite_ext(spr_puzzlemaster_face1, self.type, ((self.x + 24) + sin(self.siner)), (self.y + 16), 2, 2, 0, 0xFFFFFF, 1)
        if (self.beanie[0] == 1)
