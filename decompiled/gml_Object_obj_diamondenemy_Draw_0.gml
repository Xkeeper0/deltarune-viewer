if (self.state == 3)
{
    if (global.monsterhp[self.myself] <= (global.monstermaxhp[self.myself] / 3))
    {
        ...
        if (global.monstercomment[self.myself] == " "@24)
            global.monstercomment[self.myself] = scr_84_get_lang_string("obj_diamondenemy_slash_Draw_0_gml_6_0"@8642)
    }
    ...
    else
    {
        if (global.monster[self.myself] == 0)
        {
            if (global.flag[(51 + self.myself)] == 5)
                global.flag[523] = (global.flag[523] + 1)
            global.flag[520] = (global.flag[520] + 1)
            scr_defeatrun()
        }
