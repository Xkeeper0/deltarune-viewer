...
if (self.homing == 0)
{
    ...
    self.alarm[0] = 5
    self.fallspade = instance_create((obj_mainchara.x + self.radius), (__view_get(e__VW.YView, 0) - 500), obj_overworld_spade)
    with(self.fallspade)
    {
...
if (self.homing == 2)
{
    ...
    if (self.side == 0)
        ...
        self.radius = 560
    self.sidespade[self.side] = instance_create(self.radius, ((__view_get(e__VW.YView, 0) + 30) + random(420)), obj_overworld_spade)
    if (self.side == 0)
...
if (self.homing == 3)
{
    ...
    if (global.facing == 3)
        self.radius = (self.radius - 500)
    self.alarm[0] = 7
    self.fallspade = instance_create((obj_mainchara.x + self.radius), choose((__view_get(e__VW.YView, 0) + 550), (__view_get(e__VW.YView, 0) - 100)), obj_overworld_spade)
    with(self.fallspade)
    {
        self.damage = (self.damage - 4)
        self.damage = (self.damage + (global.battledf[0] * 2))
...
if (self.homing == 4)
{
    ...
    if (obj_mainchara.y >= 400)
    {
        ...
        while(true)
        {
            if (self.i < 6)
            {
                self.fallspade = instance_create(((220 + (20 * self.i)) + (self.side * 120)), (__view_get(e__VW.YView, 0) + 500), obj_overworld_spade)
